...
export enum Constants{
    ...
    passcode = "passcode",
    salt = "salt",
    api_base_url =`http://100.116.81.44:${backend_port}`,
    url_qr = "http://100.116.81.44:5173/table-lookup/{placeId}/{salt}",
    ...
    signalR_hub_url = `http://100.116.81.44:${backend_port}/hubs/place`
}
