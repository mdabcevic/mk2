...
{
    Task<ServiceResult<OrderDto?>> GetByIdAsync(int id,bool skipValidation);
    Task<ServiceResult<List<OrderDto>>> GetCurrentOrdersByTableLabelAsync(string tableLabel);
